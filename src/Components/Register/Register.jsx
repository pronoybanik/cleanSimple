            ...
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex items-center justify-center mt-6 duration-300">
                        <button className={`w-1/3 pb-4 duration-200 ease-linear  transition-all font-medium text-center text-gray-500 capitalize ${state === 'login' && 'border-b-2 border-blue-500'}  `}>
                            sign in
                        </button>
                        ...
                        <form onSubmit={handleSubmit(handleRegisterAtion)} >
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-6 text-center ">
                                    <Link to="/login" className="text-lg font-serif text-blue-500 hover:underline dark:text-blue-400">
